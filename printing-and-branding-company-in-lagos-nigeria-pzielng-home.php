...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="assets/logo&favicon/pzielFavicon.jpg">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav navbar-nav-scroll ms-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="pagesMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">ALL PRODUCTS</a>
                            <ul class="dropdown-menu" aria-labelledby="pagesMenu">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                                        ...
                                        <li class="dropdown-submenu dropend">
                                            ...
                                            <ul class="dropdown-menu" data-bs-popper="none">
                                                ...
                                                <li> <a class="dropdown-item" href="#">Roundneck T-shirt</a> </li>
                                                <li> <a class="dropdown-item" href="#">Polo T-Shirt</a></li>
                                                <li> <a class="dropdown-item" href="#">Monogram Printing</a> </li>
                                        ...
                                        <li class="dropdown-submenu dropend">
                                            ...
                                            <ul class="dropdown-menu" data-bs-popper="none">
                                                ...
                                                <li> <a class="dropdown-item" href="#">LetterHead</a> </li>
                                                ...
                                                <li> <a class="dropdown-item" href="#">Comapny Seal</a> </li>
                                                <li> <a class="dropdown-item" href="#">Rubber & Dater Stamp</a> </li>
                                                <li> <a class="dropdown-item" href="#">Acrylic Table Top</a> </li>
                                            </ul>
                                        </li>
                                </li>
                                <li class="dropdown-submenu dropend">
                                ...
                                <li class="dropdown-submenu dropend">
                                    ...
                                    <ul class="dropdown-menu" data-bs-popper="none">
                                        ...
                                        <li>
                                            ...
                                            <li> <a class="dropdown-item" href="#">Backdrop Banner</a> </li>
                                        </li>
                                ...
                                <li class="dropdown-submenu dropend">
                                    ...
                                    <ul class="dropdown-menu" data-bs-popper="none">
                                        <li> <a class="dropdown-item" href="#">Funeral Programme</a> </li>
                                        <li> <a class="dropdown-item" href="#">Wedding/Event Programme</a> </li>
                                        <li> <a class="dropdown-item" href="#">Menu Card</a> </li>
                                    </ul>
                                </li>
                                <li class="dropdown-submenu dropend">
                                    ...
                                    <ul class="dropdown-menu" data-bs-popper="none">
                                        ...
                                        <li> <a class="dropdown-item" href="#">Pilon Signs</a> </li>
                                        <li> <a class="dropdown-item" href="#">Glass Signs</a> </li>
                            ...
                            <ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                                <li class="dropdown-submenu dropend">
                                    ...
                                    <ul class="dropdown-menu" data-bs-popper="none">
                                        ...
                                        <li> <a class="dropdown-item" href="#">Throw Pillow</a> </li>
                                        <li> <a class="dropdown-item" href="#">Mouse Pad</a> </li>
                                        <li> <a class="dropdown-item" href="#">Key Holder</a> </li>
                                        <li> <a class="dropdown-item" href="#">Office Package</a> </li>
                                        <li> <a class="dropdown-item" href="#">Branded water Bottle</a> </li>
                                        <li> <a class="dropdown-item" href="#">Branded Steel Flask</a> </li>
                                ...
                                <li class="dropdown-submenu dropend">
                                    ...
                                    <ul class="dropdown-menu" data-bs-popper="none">
                                        ...
                                        <li> <a class="dropdown-item" href="notepad-jotter-printing.html">Notepad/Jotter</a> </li>
                                        <li> <a class="dropdown-item" href="#">Soft Cover Jotter</a> </li>
                                        <li> <a class="dropdown-item" href="#">Hard Cover Jotter</a> </li>
                                    </ul>
                                </li>
                                <li class="dropdown-submenu dropend">
                                ...
                                <li class="dropdown-submenu dropend">
                                    <a class="dropdown-item" href="#">Picture Frame</a>
                                </li>
                                <li class="dropdown-submenu dropend">
                                    <a class="dropdown-item" href="#">Season Greetings Card</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <div class="tiny-slider tns-nav-line rounded-3">
                            <div class="tiny-slider-inner" data-autoplay="true" data-hoverpause="true" data-arrow="false" data-dots="true" data-items="1">
                                ...
                                <div>
                                    <div class="row g-4 align-items-center">
                                        <div class="col-md-6 pe-md-0 pe-3">
                                            <h2 class="display-5">Creative Branding</h2>
                                            <p>Everything is good! but our branding creativity & material is the best anywhere!.</p>
                                            <!-- Rating star -->
                                            <ul class="list-inline">
                                                <li class="list-inline-item me-0"><i class="fas fa-star text-primary"></i></li>
                                                <li class="list-inline-item me-0"><i class="fas fa-star text-primary"></i></li>
                                                <li class="list-inline-item me-0"><i class="fas fa-star text-primary"></i></li>
                                                <li class="list-inline-item me-0"><i class="fas fa-star text-primary"></i></li>
                                                <li class="list-inline-item me-0"><i class="fas fa-star-half-alt text-primary"></i></li>
                                                <li class="list-inline-item me-0 h6">4.5/5.0</li>
                                            </ul>

                                            <!-- Buttons & Price -->
                                            <div class="hstack gap-4 align-items-center">
                                                <a href="mailto:pziel.ng@gmail.com" class="btn btn-primary mb-0">Send us a mail</a>
                                ...
                                <div>
                                    <div class="row g-4 align-items-center">
                                        <div class="col-md-6">
                                            <h2 class="display-5">Box Branding</h2>
                                            <p> Make your brand outstanding by packaging your product in a well suited box branded with premium materials</p>
                                            <!-- Rating star -->
                                            <ul class="list-inline">
                                                <li class="list-inline-item me-0"><i class="fas fa-star text-primary"></i></li>
                                                <li class="list-inline-item me-0"><i class="fas fa-star text-primary"></i></li>
                ...
                <div class="row g-4 g-xl-5">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="d-flex align-items-center">
                            ...
                            <h6 class="mb-0 ms-3">You can order now to get your job very quickly</h6>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="d-flex align-items-center">
                            ...
                            <h6 class="mb-0 ms-3">Customer Satisfaction is our greatest priority</h6>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h3 class="m-0">Design & Printing &#128525;</h3>
                        </div>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <div class="card border p-3 h-100">
                            ...
                            <div class="card-body text-center p-3 px-0">
                                ...
                                <!-- Title -->
                                <h5 class="card-title"><a href="wedding-invitation-card-printing.html#premiumWeddingCard">Wedding Invitation Card</a></h5>
                            </div>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <div class="card border p-3 h-100">
                            ...
                            <div class="card-body text-center p-3 px-0">
                                ...
                                <!-- Title -->
                                <h5 class="card-title"><a href="premium-business-card-printing.html#premiumCard">Premium Business Card</a></h5>
                            </div>
        ...
        <div class="container">
            ...
            <div class="row pt-5">
                ...
                <div class="col-sm-6 col-lg-4 mb-4">
                    ...
                    <ul class="nav flex-column text-primary-hover">
                        <li class="nav-item"><a class="nav-link" href="googlemap.com"><i class="fs-5 bi bi-geo-alt me-3"></i>34, Oguntolu Street Shomolu, Lagos, Nigeria</a></li>
                ...
                <div class="col-sm-6 col-lg-3 mb-4">
                    <h6 class="mb-3 text-white">Social Media</h6>
                    ...
                    <a href="https://www.linkedin.com/in/pziel-ng-037772267" target="_blank"><i class="fab fa-linkedin fa-fw text-linkedin fs-3 text-primary"></i> </a> </div>
            </div>
            <!-- Widgets END -->
        </div>
        <hr>
                ...
                <div class="row align-items-center justify-content-md-between py-4">
                    <div class="col-md-6">
                        ...
                        <div class="text-center text-md-start text-primary-hover text-muted">Copyright © 2022 - 2023
                            <a href="https://www.pziel.com/" class="text-reset btn-link" target="_blank">PZIEL</a>. All rights reserved.
                        </div>
                    </div>
